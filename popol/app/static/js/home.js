...
$(document).ready(function () {
        ...
        function ls() {
                terminal.append("Introduce\tProject\nSkill\n");
        }

        function hello() {
                terminal.append("저도 반가워요!\n");
        }

        // 해당주소에서 랜덤 크롤링하여 명언? 말하기
        function fortune() {
        ...
        */
        ...
        title.text("byeongho@byeongho-portfolio: ~ (zsh)");
        ...
        terminal.append("Last update: 2020.12.30\n");
        displayPrompt();
});